    ...
    switch (media.type) {
      case "err":
        return (
          <View style={{ marginRight: 7 }}>
            <Text style={[styles.err, styles.text]}>삭제된 미디어</Text>
          </View>
        );
      ...
      case "pic":
        ...
        return (
          <TouchableOpacity
            onPress={async () => {
              await openBrowserAsync(media.download);
            }}
          >
            <View style={{ marginRight: 7 }}>
              <Image
                style={[{ borderRadius: 15, borderTopLeftRadius: 0 }, picStyle]}
          ...
          >
            <View style={{ marginRight: 7 }}>
              ...
              >
                ...
                <Text style={{ fontSize: 14.8, lineHeight: 24 }}>
                  {" "}
                  {media.length}
                </Text>
              </View>
